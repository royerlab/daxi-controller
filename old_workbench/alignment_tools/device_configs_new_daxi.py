...
VSG1_view1['instrument name'] = "DaXi"
VSG1_view1['channel I/O type'] = "AO"  #
VSG1_view1['channel_string'] = "cDAQ1-AO-NI9263/ao2"  # name of the DAQ channel that will be used to control the device
...
VSG1_view1['home offset voltage'] = 0  # this is an offset voltage to set on top of the home voltage value.
...
VSG2_view1['instrument name'] = "DaXi"
VSG2_view1['channel I/O type'] = "AO"  #
VSG2_view1['channel_string'] = "cDAQ1-AO-NI9263/ao2"  # name of the DAQ channel that will be used to control the device
...
VSG2_view1['home offset voltage'] = 0  # this is an offset voltage to set on top of the home voltage value.
...
VSG1_view2['instrument name'] = "DaXi"
VSG1_view2['channel I/O type'] = "AO"  #
VSG1_view2['channel_string'] = "cDAQ1-AO-NI9263/ao2"  # name of the DAQ channel that will be used to control the device
...
VSG1_view2['home offset voltage'] = 0  # this is an offset voltage to set on top of the home voltage value.
...
VSG2_view2['instrument name'] = "DaXi"
VSG2_view2['channel I/O type'] = "AO"  #
VSG2_view2['channel_string'] = "cDAQ1-AO-NI9263/ao2"  # name of the DAQ channel that will be used to control the device
...
VSG2_view2['home offset voltage'] = 0  # this is an offset voltage to set on top of the home voltage value.
