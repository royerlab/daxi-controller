...
def demo_inspectionfcltr_execute_bright_field():
    ...
    process_configs['process type'] = 'inspection, inspect_bright_field'
    process_configs['process configs']['process type'] = 'inspection, inspect_bright_field'
