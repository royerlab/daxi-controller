...
def demo_inspectionfcltr_execute_counter():
    ...
    process_configs['process type'] = 'inspection, inspect_counter'
    process_configs['process configs']['process type'] = 'inspection, inspect_counter'
