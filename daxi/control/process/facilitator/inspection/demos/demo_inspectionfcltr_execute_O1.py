...
# here we demonstrate how to use an InspectionFcltr to inspect O1 piezo stage (turn on, start, stop, close).
...
def demo_inspectionfcltr_execute_O1():
    ...
    process_configs['process type'] = 'inspection, inspect_O1'
    process_configs['process configs']['process type'] = 'inspection, inspect_O1'
