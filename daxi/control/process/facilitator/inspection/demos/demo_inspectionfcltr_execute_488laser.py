...
# here we demonstrate how to use an InspectionFcltr to inspect 488 galvo (turn on, start, stop, close).
...
def demo_inspectionfcltr_execute_488_laser():
    ...
    process_configs['process type'] = 'inspection, inspect_488_laser'
    process_configs['process configs']['process type'] = 'inspection, inspect_488_laser'
