...
# here we demonstrate how to use an InspectionFcltr to inspect gamma galvo (turn on, start, stop, close).
...
def demo_inspectionfcltr_execute_gammaG():
    ...
    process_configs['process type'] = 'inspection, inspect_gamma_galvo_strip_reduction'
    process_configs['process configs']['process type'] = 'inspection, inspect_gamma_galvo_strip_reduction'
