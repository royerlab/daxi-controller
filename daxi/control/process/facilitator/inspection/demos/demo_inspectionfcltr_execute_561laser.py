...
# here we demonstrate how to use an InspectionFcltr to inspect 561 galvo (turn on, start, stop, close).
...
def demo_inspectionfcltr_execute_561_laser():
    ...
    process_configs['process type'] = 'inspection, inspect_561_laser'
    process_configs['process configs']['process type'] = 'inspection, inspect_561_laser'
