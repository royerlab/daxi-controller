...
def demo_inspectionfcltr_execute_metronome():
    ...
    process_configs['process type'] = 'inspection, inspect_metronome'
    process_configs['process configs']['process type'] = 'inspection, inspect_metronome'
