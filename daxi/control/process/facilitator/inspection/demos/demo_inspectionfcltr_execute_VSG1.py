...
# here we demonstrate how to use an InspectionFcltr to inspect the view switching galvo 1 (turn on, start, stop, close).
...
def demo_inspectionfcltr_execute_VSG1():
    ...
    process_configs['process type'] = 'inspection, inspect_view_switching_galvo1'
    process_configs['process configs']['process type'] = 'inspection, inspect_view_switching_galvo1'
