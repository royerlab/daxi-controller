...
def demo_acquisitionfcltr_acquisition_mode8(config_fname):
    ...
    af.acquisition_mode8()
    return 'success'


if __name__ == '__main__':
    demo_acquisitionfcltr_acquisition_mode8(config_fname='template_acquisition_mode8-dev-thick_stack_488only.yaml')
