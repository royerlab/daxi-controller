...
m = AcqParamMode7(dx=0.4,
                  ...
                  t_exposure=20,
                  t_readout=10,
                  t_stage_retraction=20,  # retraction time for the stage after a stack acquisition is done.
...
path = os.path.join(process_templates, 'pytest_mini_session_mode7.yaml')
