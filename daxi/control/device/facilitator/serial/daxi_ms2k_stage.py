...
class DaxiMs2kStage(SerialPort):
    ...
    def config_raster_scan(self,
        ...
        encoder_divide: int
            ref: http://asiimaging.com/docs/scan_module
            ...
            Xiyu-2022-09-16:
            where the range is 1 mm. (start = 0, stop = 1, unit is mm)
            step length (pixel length) is encoder_divide (24 count) * encoder resolution (0.022 um/count) = 0.528 um
            total number of steps (pixels) would then be 1 mm/0.528 um = 1891 steps.
            now the question here is, how to set the speed?
