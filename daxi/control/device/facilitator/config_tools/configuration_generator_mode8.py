...
class NIDAQDevicesConfigsGeneratorMode8(NIDAQDevicesConfigsGeneratorBase):
    """
    ...
    def get_configs_gamma_galvo_strip_reduction(self, params):
        self.configs_gamma_galvo_strip_reduction['data configs']['sample number'] = \
            self.sample_number_total
        ...
        if self.configs_gamma_galvo_strip_reduction['data generator'] == 'constant':
            data_view1 = dg.constant(n_samples=self.sample_number_total,
                                     constant=self.configs_gamma_galvo_strip_reduction['home voltage offset for view 1']
                                     )
            data_view2 = dg.constant(n_samples=self.sample_number_total,
                                     constant=self.configs_gamma_galvo_strip_reduction['home voltage offset for view 2']
                                     )
            self.configs_gamma_galvo_strip_reduction['data for view 1'] = list(data_view1)
            self.configs_gamma_galvo_strip_reduction['data for view 2'] = list(data_view2)
    ...
    def get_configs_o1(self, params):
        ...
        if self.configs_o1['data generator'] == 'constant':
            ...
            self.configs_o1['data for view 1'] = list(data_view1)
            self.configs_o1['data for view 2'] = list(data_view2)
    ...
    def map_sc_configs_gamma_galvo_strip_reduction(self, view=None, color=None):
        ...
        configs = {
            'data': origin['data for view ' + str(view)],
            'data configs': {'sample number': origin['data configs']['sample number'],
                             'type': origin['data configs']['type']},
            'data generator': origin['data generator'],
            'device': origin['device'],
            'idle state': origin['idle state'],
...
class CameraConfigsGeneratorMode8(CameraConfigsGeneratorMode1):
    """
...
class StageConfigsGeneratorMode8(StageConfigsGeneratorMode1):
    def __init__(self,
